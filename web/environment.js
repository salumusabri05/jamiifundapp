// This file allows Netlify to set environment variables at build time
// You can access these variables by setting them in your Netlify deploy settings

window.ENV = {
  // These are the default values that will be used if env vars aren't set in Netlify
